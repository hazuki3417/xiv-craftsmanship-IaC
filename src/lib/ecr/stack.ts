...
export class Ecr extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: cdk.StackProps) {
    ...
    new cdk.CfnOutput(this, name.ecr.db.cfn.arn.id, {
      value: this.db.repositoryArn,
      exportName: name.ecr.db.cfn.arn.export,
    });

    new cdk.CfnOutput(this, name.ecr.api.cfn.arn.id, {
      value: this.api.repositoryArn,
      exportName: name.ecr.api.cfn.arn.export,
    });

    new cdk.CfnOutput(this, name.ecr.web.cfn.arn.id, {
      value: this.web.repositoryArn,
      exportName: name.ecr.web.cfn.arn.export,
    });
  }
}
